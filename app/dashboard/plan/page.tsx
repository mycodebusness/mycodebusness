            ...
            <ul className="timeline">
                ...
                <div className="timeline-panel">
                  ...
                  <div className="timeline-body">
                    <p className="text-muted">
                      ...
                      essentiel de maîtriser les outils de base de l'interaction
                      avec l'ordinateur : le clavier et la souris. Comprendre
                      leur fonctionnement et les raccourcis courants est la
                      première étape vers une utilisation efficace de la
                      technologie.
                    </p>
                ...
                <div className="timeline-panel">
                  ...
                  <div className="timeline-body">
                    <p className="text-muted">
                      ...
                      structurer le contenu d'un site web de manière sémantique,
                      facilitant ainsi la compréhension et l'accessibilité.
                    </p>{" "}
                    <h4 className="bg-slate-800 rounded-md text-sm mb-2 px-1">
              ...
              <li>
                ...
                <div className="timeline-panel">
                  ...
                  <div className="timeline-body">
                    <p className="text-muted">
                      La programmation web englobe l'ensemble des compétences
                      nécessaires pour développer des sites web dynamiques et
                      fonctionnels, en utilisant les langages et les
                      technologies mentionnés précédemment. Cela inclut la
